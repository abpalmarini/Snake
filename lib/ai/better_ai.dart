...
is furthest away from the previous apple location first as the surrounding area
has a higher probability of being empty.

Also added an inEscape property where when it has to make a move off course to 
survive it will then enter escape mode and it will keep going in that direction
